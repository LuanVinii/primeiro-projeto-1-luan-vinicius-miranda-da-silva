...
public class MessageBroker {
    ...
    public void notifyConsumers() {
                    ...
                    messages.forEach(message -> {
                        ...
                        if (topic != null) {
                            try {
                                ...
                                // Consome a mensagem após notificar
                                repository.consumeMessage(key, null);
                            } catch (Exception e) {
                                System.err.println("Error notifying consumer: " + e.getMessage());
                            }
                        }
                    });
                }
        ...
        ScheduledFuture<?> scheduledFuture = scheduleAtFixedRate
                .scheduleAtFixedRate(notifyTask, 0, 1, TimeUnit.MINUTES);
    }

    public void shutdown() throws InterruptedException {
        scheduleAtFixedRate.shutdown();
        if (!scheduleAtFixedRate.awaitTermination(60, TimeUnit.SECONDS)) {
